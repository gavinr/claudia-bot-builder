...
module.exports = function validateAlexaSignature(request) {
  ...
  const normalizedUrl = path.normalize(certSignatureUrl);
  console.log('normalizedUrl', normalizedUrl);
  const parsedCertSignatureUrl = url.parse(normalizedUrl, true);
  console.log('parsed url:', parsedCertSignatureUrl);
